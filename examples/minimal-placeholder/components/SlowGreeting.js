...
console.log('[SlowGreeting] - Module loaded after delay');

// Define the component
export function SlowGreeting({ name = 'User' }) {
  ...
  onMount(() => {
    console.log('[SlowGreeting] - Component mounted');
  });
...
component(SlowGreeting);

// Export the component
export default SlowGreeting;
